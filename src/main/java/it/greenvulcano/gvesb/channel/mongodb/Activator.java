...
import it.greenvulcano.gvesb.virtual.mongodb.MongoDBScriptCallOperation;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		OperationFactory.registerSupplier("mongodb-script-call", MongoDBScriptCallOperation::new);
